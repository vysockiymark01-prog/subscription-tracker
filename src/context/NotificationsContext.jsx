...
import { useReminders } from './RemindersContext.jsx';
...
export function NotificationsProvider({ children }) {
  ...
  useEffect(() => {
    ...
    notifications.checkAndNotify(activeSubscriptions, language, reminders);
  }, [activeSubscriptions, language, reminders]);
