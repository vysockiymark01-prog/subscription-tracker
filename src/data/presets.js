...
// Сгруппированы по темам, чтобы длинный список эмодзи было проще просматривать
// в выборе иконки (подписки и напоминания используют один и тот же набор).
...
// Плоский список — для мест, где важен только сам факт "это валидный эмодзи из набора".
export const ICON_EMOJIS = EMOJI_CATEGORIES.flatMap((c) => c.emojis);
